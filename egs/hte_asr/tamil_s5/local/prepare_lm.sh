...
local/get_text_from_transcript.py data/train_Tamil_final/text $train_text
local/get_text_from_transcript.py data/dev_Tamil_jhu_ho_spk/text $dev_text
...
ngram -order 5 -lm $tgtdir/lm5.gz -unk -map-unk "<UNK>" -ppl $dev_text
